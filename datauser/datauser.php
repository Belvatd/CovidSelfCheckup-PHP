...
<div class="container" style="margin-top:20px">
        ...
        <table class="table table-striped table-hover table-sm table-bordered">
            ...
            <tbody>
                <?php
				$sql = mysqli_query($koneksi, "SELECT * FROM `user` WHERE id_level='user' ORDER BY id DESC") or die(mysqli_error($koneksi));
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php include('modal_formuser.php'); ?>
        ...
        <div>
            <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#myModal"
                data-title="tambahBuku">Tambah User</button>
        </div>
